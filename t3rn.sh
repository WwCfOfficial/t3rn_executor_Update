...
echo ">>============================================================<<";
echo "||W)      ww                                      ## C)CCCC  f)FFFF||";
echo "||W)      ww                                         C)      f)    ||";
echo "||W)  ww  ww  W)wW  C)CCCC  f)FFFF                  C)      f)FFF ||";
echo "||W)  ww  ww  W)wW  C)      f)                      C)      f)    ||";
echo "|| W)ww  wwW  WwW   C)      f)                      C)      f)    ||";
echo "||  W)    W)  W)     C)CCCC f)                       C)CCCC f)    ||";
echo ">>============================================================<<";



echo -e "${ORANGE}-----------------------------------------------------${NC}"
echo -e "${GREEN}Get Contabo Cloud VPS:${NC} ${ORANGE}https://contabo.com/en/vps/${NC}"
echo -e "${GREEN}Get free Alchemy API:${NC} ${ORANGE}https://alchemy.com/?r=b66a944e397e5e50${NC}"
sleep 3
